 ...
 * This can happen when a reactive block or effect repeatedly sets a new value. Svelte limits the number of nested updates to prevent infinite loops
 */
...
/**
 * Updating state inside a derived or a template expression is forbidden.
